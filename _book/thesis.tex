...
Where \(X_{ij} \overset{\text{iid}}{\sim} \mathcal{N}(0, 1)\), \(v_j \overset{\text{iid}}{\sim} \mathcal{N}(0, 1)\) and \(u_{j} \overset{\text{iid}}{\sim} \mathcal{N}(0, 1)\)
...
{\centering \includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/keep-1} 
