...
```{r zi_ex, echo=F, message=F, warning=F, cache=T, fig.align='center', out.width='80%'}
set.seed(6)
library(tidyverse)
library(here)
library(gt)
...
```{r forestry_data, echo = F, message=F, warning = F, cache=T, fig.align='center', out.width='80%'}
...
```{r scatter_zi, echo=F, message=F, warning=F, cache=T, fig.align='center', out.width='80%'}
data %>% 
  slice_sample(n = 1500) %>% 
