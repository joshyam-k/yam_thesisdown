...
```{r gamma, echo = F, warning = F, message = F, fig.align = 'center', out.width="80%", fig.cap="test"}
...
\hat{y}_{ij} &= \hat{y}^*_{ij}\cdot \hat{p}_{ij} \\
\hat{\bar{y}_j} &= \sum_{i \in n_j}\hat{y}_{ij}
\end{aligned}
$$
