...
```{r ci-coverage-ex, message=F, warning=F, echo=F, fig.align='center', out.width='80%'}
library(tidyverse)
set.seed(7)
pop <- rnorm(10000, 5, 1)
...
```{r bayes-dists, echo=F, message=F, warning=F, fig.align='center', out.width='80%'}
library(tidyverse)
set.seed(110)
